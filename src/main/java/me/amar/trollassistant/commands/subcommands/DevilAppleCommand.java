...
public class DevilAppleCommand extends SubCommand {
    ...
    public void preform(Player p, String[] args) {
        ...
        if (!p.hasPermission("troll.devilapple")) {
        ...
        p.sendMessage(TrollAssistant.colorize("&2[&6Troll Assistant&2] " + target.getDisplayName() + " &chas been trolled with the &bDevil Apple &ctroll."));
